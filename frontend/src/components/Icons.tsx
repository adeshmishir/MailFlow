export function MailFlowLogo({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect width="32" height="32" rx="8" fill="#059669" />
      <path
        d="M8 11L16 17L24 11M8 11V21C8 21.5523 8.44772 22 9 22H23C23.5523 22 24 21.5523 24 21V11M8 11C8 10.4477 8.44772 10 9 10H23C23.5523 10 24 10.4477 24 11"
        stroke="white"
        strokeWidth="2"
        strokeLinecap="round"
...
export function PaperPlaneIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export function BoldIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
...
export function ItalicIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export function UnderlineIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export function StrikethroughIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M4 12h16M17.5 7A4.5 4.5 0 007 7.5M6.5 16.5A4.5 4.5 0 0017 17" />
    </svg>
  );
}
...
export function ListOrderedIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M7 6h14M7 12h14M7 18h14M3 5v2m0-2h1m-1 7h1.5M3 17h2" />
    </svg>
  );
}
...
export function PlugIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M8 9V5a1 1 0 011-1h6a1 1 0 011 1v4m-4 3v3h1a3 3 0 013 3v3a2 2 0 01-2 2H9a2 2 0 01-2-2v-3a3 3 0 013-3h1z"
      />
    </svg>
  );
}
